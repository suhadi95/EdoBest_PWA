            ...
            <div class="ui-menu">
                @foreach ($outlets as $outlet_item)
                    @php
                        ...
                        $cashBrief = $rekap ? ($rekap->cash_di_pegawai ?? ($rekap->total_tunai ?? 0)) : null;
                    @endphp
                    <a href="{{ route('operasional.detail', $outlet_item->id) }}" class="ui-menu__item">
                        ...
                        <div class="ui-menu__text">
                            ...
                            <span>
                                ...
                                @if($cashBrief !== null)
                                    · Cash: Rp {{ number_format($cashBrief, 0, ',', '.') }}
                                @endif
                            </span>
                        </div>
