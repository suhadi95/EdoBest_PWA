...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title"><i class="bi bi-file-text me-2"></i>Laporan Rekap Harian</h5>
                @if (session('success'))
                        ...
                        <tbody>
                            @forelse ($outlets as $index => $outlet_item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.rekap.detail', $outlet_item->id) }}" class="btn btn-sm btn-outline-primary">
